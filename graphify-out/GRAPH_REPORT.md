...
- `Asim Khan — Engineering Vice President` --references--> `Goldman Sachs Logo`  [INFERRED]
  index.html → public/gs.jpg
- `Asim Khan — Engineering Vice President` --references--> `Accenture Logo — Blue Arrow Brand Mark`  [INFERRED]
  index.html → public/accenture.webp
- `Asim Khan — Engineering Vice President` --references--> `Citi (Citibank) Logo — Blue and Red Brand Mark`  [INFERRED]
  index.html → public/citi.png
- `Asim Khan — Engineering Vice President` --references--> `Nok Nok Labs Logo — Authentication Technology Company`  [INFERRED]
  index.html → public/noknok.png
- `Asim Khan — Engineering Vice President` --references--> `Dr. APJ Abdul Kalam Technical University Logo — Lucknow, Uttar Pradesh`  [INFERRED]
  index.html → public/Dr._A.P.J._Abdul_Kalam_Technical_University_logo.png

## Hyperedges (group relationships)
- **Portfolio Tech Stack** — tech_react, tech_typescript, tech_vite, tech_tailwind, tech_framer_motion, tech_github_pages [EXTRACTED 1.00]
- **Page Section Components** — component_hero, component_about, component_experience, component_skills, component_projects, component_education, component_contact [EXTRACTED 1.00]
- **Employer Brand Logos** — gs_logo, accenture_logo, citi_logo, noknok_logo [INFERRED 0.80]
- **Education Institution Logos** — aktu_logo, nu_wordmark [INFERRED 0.80]
- **Hero Ghost Background Layer Stack** — asim_image_jpg, component_hero, tech_framer_motion, tech_tailwind [EXTRACTED 1.00]
...
Cohesion: 0.67
Nodes (3): Matrix-Style Green Code Rain Background — Hero Section Image, Hero Ghost Background Implementation Plan, Rationale: Ghost background chosen for low-opacity fade-in effect preserving text readability
